    ...
    <>
      ...
      {isLoaded && (
        <motion.main
          ...
          className="min-h-screen bg-gray-950 text-foreground pt-24"
        >
          <section className="container mx-auto px-4">
            ...
            <div className="flex flex-col items-center mb-16">
              ...
              >
                <h1 className="text-5xl md:text-7xl font-bold mb-4 bg-gradient-to-r from-orange-500 via-red-500 to-pink-500 text-transparent bg-clip-text">
                  {t('youAreNotAlone')}
                </h1>
              ...
              <div className="w-full max-w-4xl">
                <AnimatePresence mode="wait">
                  ...
                  >
                    {/* Centered title */}
                    <motion.h2 
                      className="text-3xl md:text-4xl font-bold text-orange-500 text-center mb-6"
                    ...
                    <div className="text-right">
                      <AnimatedText 
                        ...
                        className="text-base md:text-lg text-muted-foreground leading-relaxed max-w-2xl ml-auto"
                      />
                    </div>
                  </motion.div>
                </AnimatePresence>
            ...
            <div id="community" className="grid md:grid-cols-2 gap-8 mt-12">
              <SafetyZones />
